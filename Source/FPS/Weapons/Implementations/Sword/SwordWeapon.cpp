...
void USwordWeapon::PerformAttack()
{
    ...
    const float KickYaw = (LastDirection == ESlashDirection::LeftToRight) ? -KickbackYawAmount : KickbackYawAmount;
    TriggerCameraKickback(KickbackPitchAmount, KickYaw, KickbackDuration);
}
